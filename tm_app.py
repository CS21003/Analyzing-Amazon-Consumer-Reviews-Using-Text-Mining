...
TEXT = pd.read_csv('/content/drive/My Drive/csv_files/01_app_rtext.csv')
TEXT.head()
...
TEXT = TEXT.dropna()
TEXT.to_csv('/content/drive/My Drive/csv_files/app_TEXT.csv')
...
pickle.dump(text, open('/content/drive/My Drive/csv_files/01_app_rtext2_text2.pk', 'wb'))
pickle.dump(dtm, open('/content/drive/My Drive/csv_files/01_app_rtext2_dtm2.pk', 'wb'))
id2word.save('/content/drive/My Drive/csv_files/01_app_rtext2_id2word2')

text = pickle.load(open('/content/drive/My Drive/csv_files/01_app_rtext2_text2.pk', 'rb'))
dtm = pickle.load(open('/content/drive/My Drive/csv_files/01_app_rtext2_dtm2.pk', 'rb'))
id2word = corpora.Dictionary.load('/content/drive/My Drive/csv_files/01_app_rtext2_id2word2')
...
# Tables #
#--------------------------------------------------#
TEXT = pd.read_csv('/content/drive/My Drive/csv_files/app_TEXT.csv')
text = pickle.load(open('/content/drive/My Drive/csv_files/01_app_rtext2_text2.pk', 'rb'))
dtm = pickle.load(open('/content/drive/My Drive/csv_files/01_app_rtext2_dtm2.pk', 'rb'))
id2word = corpora.Dictionary.load('/content/drive/My Drive/csv_files/01_app_rtext2_id2word2')
...
for docID in range(len(dtm)):
  result = model.get_document_topics(dtm[docID], minimum_probability=None, minimum_phi_value=None, per_word_topics=False)
  review = (docID, result[0][1], result[1][1], result[2][1], result[3][1], result[4][1])
  review_table.append(review)

review_table = pd.DataFrame(review_table, columns = ['Review', 'Topic 1', 'Topic 2', 'Topic 3', 'Topic 4', 'Topic 5'])
review_table
...
review_table.to_csv('/content/drive/My Drive/csv_files/app_reviewtable.csv')
dummy_rtable = pd.read_csv('/content/drive/My Drive/csv_files/app_reviewtable.csv')
...
dummy_rtable.to_csv('/content/drive/My Drive/csv_files/app_dummy_rtable.csv')
...
data_rinfo = pd.read_csv('/content/drive/My Drive/csv_files/01_app_rinfo.csv')
...
data_user = pd.read_csv('/content/drive/My Drive/csv_files/01_app_user.csv') # --> review author characteristics
...
data_meta = pd.read_csv('/content/drive/My Drive/csv_files/01_app_meta.csv')
...
data
data.to_csv('/content/drive/My Drive/csv_files/app_data.csv')

review_table = pd.read_csv('/content/drive/My Drive/csv_files/app_dummy_rtable.csv')
...
data = data.rename(columns = {'Topic 1' : '"ProductMaintenance"'})
data = data.rename(columns = {'Topic 2' : '"ConsumerSatisfaction"'})
data = data.rename(columns = {'Topic 3' : '"ProductAppearance"'})
data = data.rename(columns = {'Topic 4' : '"BigTicketItems"'})
...
data = data[['asin', 'user', 'HELPFUL', 'VerifiedReview', 'ReviewRating', 'ReviewLength', 
             ...
             '"ProductMaintenance"', '"ConsumerSatisfaction"', '"ProductAppearance"', 
             '"BigTicketItems"']]

data

data.to_csv('/content/drive/My Drive/csv_files/app_data.csv')
data = pd.read_csv('/content/drive/My Drive/csv_files/app_data.csv') 
data
...
df1 = pd.DataFrame({'ReviewRating' : data['ReviewRating'], 'reviewCount': data.groupby('ReviewRating')['ReviewRating'].transform('count')})
...
data_log['"ProductMaintenance"'] = data['"ProductMaintenance"']
data_log['"ConsumerSatisfaction"'] = data['"ConsumerSatisfaction"']
data_log['"ProductAppearance"'] = data['"ProductAppearance"']
data_log['"BigTicketItems"'] = data['"BigTicketItems"']

data_log

data_log.to_csv('/content/drive/My Drive/csv_files/app_data_log.csv')
data_log = pd.read_csv('/content/drive/My Drive/csv_files/app_data_log.csv')
...
cols4 = ["VerifiedReview", "ReviewRating", "ReviewLength", "ReviewImages", "ReviewPostingOrder", 
         "ReviewAuthorExperience", "ReviewAuthorReputation", "ReviewAuthorCredibility", "AverageRatingByReviewAuthor", 
         "ProductAverageRating", "ProductRank", "ProductPrice", "ProductTitleLength", "ProductDescriptionLength", 
         '"ProductMaintenance"', '"ConsumerSatisfaction"', '"ProductAppearance"', '"BigTicketItems"']
...
def coefplot(result):
    ...
    c = np.array(["orange","mediumaquamarine","palevioletred","palevioletred",
                  "palevioletred","cornflowerblue","cornflowerblue",
                  "cornflowerblue","cornflowerblue","mediumaquamarine",
                  "mediumaquamarine","mediumaquamarine","mediumaquamarine",
                  "palevioletred","palevioletred","orange","orange","orange"])
