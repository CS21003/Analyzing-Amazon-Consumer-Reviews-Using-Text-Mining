...
# Random Sampling #
#--------------------------------------------------#
TEXT = pd.read_csv('/content/drive/My Drive/csv_files/01_cds_rtext.csv')
TEXT = TEXT.dropna()
TEXT.head()

TEXT = TEXT.sample(frac = 0.25, replace = False, weights = None, random_state = 100)
TEXT.count()

TEXT.to_csv('/content/drive/My Drive/csv_files/02_cds_asin.csv')


#--------------------------------------------------#
# Topic Modelling #
#--------------------------------------------------#
TEXT = pd.read_csv('/content/drive/My Drive/csv_files/02_cds_asin.csv')
...
TEXT.to_csv('/content/drive/My Drive/csv_files/cds_TEXT.csv')
TEXT = pd.read_csv('/content/drive/My Drive/csv_files/cds_TEXT.csv')
...
pickle.dump(text, open('/content/drive/My Drive/csv_files/01_cds_rtext_text.pk', 'wb'))
pickle.dump(dtm, open('/content/drive/My Drive/csv_files/01_cds_rtext_dtm.pk', 'wb'))
id2word.save('/content/drive/My Drive/csv_files/01_cds_rtext_id2word')

text = pickle.load(open('/content/drive/My Drive/csv_files/01_cds_rtext_text.pk', 'rb'))
dtm = pickle.load(open('/content/drive/My Drive/csv_files/01_cds_rtext_dtm.pk', 'rb'))
id2word = corpora.Dictionary.load('/content/drive/My Drive/csv_files/01_cds_rtext_id2word')
...
model.save('/content/drive/My Drive/csv_files/cds_model.pk')
model = LdaModel.load('/content/drive/My Drive/csv_files/cds_model.pk')
...
for _, (asin, user, text) in TEXT.iterrows():
  bow = id2word.doc2bow([word for word in text])
...
review_table.to_csv('/content/drive/My Drive/csv_files/cds_reviewtable.csv')
dummy_rtable = pd.read_csv('/content/drive/My Drive/csv_files/cds_reviewtable.csv')
...
dummy_rtable.to_csv('/content/drive/My Drive/csv_files/cds_dummy_rtable.csv')
...
data_rinfo = pd.read_csv('/content/drive/My Drive/csv_files/01_cds_rinfo.csv')
...
data_user = pd.read_csv('/content/drive/My Drive/csv_files/01_cds_user.csv')
...
data_meta = pd.read_csv('/content/drive/My Drive/csv_files/01_cds_meta.csv')
...
data
data.to_csv('/content/drive/My Drive/csv_files/cds_data.csv')

review_table = pd.read_csv('/content/drive/My Drive/csv_files/cds_dummy_rtable.csv')
...
data = data.rename(columns = {'Topic 1' : '"AlbumDescription"'})
data = data.rename(columns = {'Topic 2' : '"RockGenre"'})
data = data.rename(columns = {'Topic 3' : '"Shows"'})
data = data.rename(columns = {'Topic 4' : '"LivePerformance"'})
...
data = data[['asin', 'user', 'HELPFUL', 'VerifiedReview', 'ReviewRating', 'ReviewLength', 
             ...
             '"AlbumDescription"', '"RockGenre"', '"Shows"', '"LivePerformance"']]

data

data.to_csv('/content/drive/My Drive/csv_files/cds_data.csv')
data = pd.read_csv('/content/drive/My Drive/csv_files/cds_data.csv') 
data
...
data_log['"AlbumDescription"'] = data['"AlbumDescription"']
data_log['"RockGenre"'] = data['"RockGenre"']
data_log['"Shows"'] = data['"Shows"']
data_log['"LivePerformance"'] = data['"LivePerformance"']

data_log

data_log.to_csv('/content/drive/My Drive/csv_files/cds_data_log.csv')
data_log = pd.read_csv('/content/drive/My Drive/csv_files/cds_data_log.csv')
...
def coefplot(result):
    ...
    c = np.array(["mediumaquamarine","palevioletred","orange","palevioletred",
                  "mediumaquamarine","palevioletred","cornflowerblue",
                  "mediumaquamarine","mediumaquamarine","cornflowerblue",
                  "mediumaquamarine","orange","palevioletred","cornflowerblue",
                  "orange","palevioletred","cornflowerblue","orange"])
