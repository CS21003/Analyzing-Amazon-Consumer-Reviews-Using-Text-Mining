...
TEXT = pd.read_csv('/content/drive/My Drive/csv_files/01_bea_rtext.csv')
TEXT.head()
...
pickle.dump(text, open('/content/drive/My Drive/csv_files/01_bea_rtext_text.pk', 'wb'))
pickle.dump(dtm, open('/content/drive/My Drive/csv_files/01_bea_rtext_dtm.pk', 'wb'))
id2word.save('/content/drive/My Drive/csv_files/01_bea_rtext_id2word')

text = pickle.load(open('/content/drive/My Drive/csv_files/01_bea_rtext_text.pk', 'rb'))
dtm = pickle.load(open('/content/drive/My Drive/csv_files/01_bea_rtext_dtm.pk', 'rb'))
id2word = corpora.Dictionary.load('/content/drive/My Drive/csv_files/01_bea_rtext_id2word')
...
review_table.to_csv('/content/drive/My Drive/csv_files/bea_reviewtable.csv')

dummy_rtable = pd.read_csv('/content/drive/My Drive/csv_files/bea_reviewtable.csv')
...
dummy_rtable.to_csv('/content/drive/My Drive/csv_files/bea_dummy_rtable.csv')
...
data_rinfo = pd.read_csv('/content/drive/My Drive/csv_files/01_bea_rinfo.csv')
...
data_user = pd.read_csv('/content/drive/My Drive/csv_files/01_bea_user.csv')
...
data_meta = pd.read_csv('/content/drive/My Drive/csv_files/01_bea_meta.csv')
...
data
data.to_csv('/content/drive/My Drive/csv_files/bea_data.csv')

review_table = pd.read_csv('/content/drive/My Drive/csv_files/bea_dummy_rtable.csv')
...
data = data.rename(columns = {'Topic 1' : '"Scent"'})
data = data.rename(columns = {'Topic 2' : '"Texture"'})
data = data.rename(columns = {'Topic 3' : '"ConsumerSatisfaction"'})
...
data = data[['asin', 'user', 'HELPFUL', 'VerifiedReview', 'ReviewRating', 'ReviewLength', 
             ...
             '"Scent"', '"Texture"', '"ConsumerSatisfaction"', '"ProductAppearance"']]

data

data.to_csv('/content/drive/My Drive/csv_files/bea_data.csv')
data = pd.read_csv('/content/drive/My Drive/csv_files/bea_data.csv') 
data
...
data_log['"Scent"'] = data['"Scent"']
data_log['"Texture"'] = data['"Texture"']
data_log['"ConsumerSatisfaction"'] = data['"ConsumerSatisfaction"']
data_log['"ProductAppearance"'] = data['"ProductAppearance"']

data_log

data_log.to_csv('/content/drive/My Drive/csv_files/bea_data_log.csv')
data_log = pd.read_csv('/content/drive/My Drive/csv_files/bea_data_log.csv')
...
def coefplot(result):
    ...
    c = np.array(["mediumaquamarine","orange","palevioletred","palevioletred",
                  "mediumaquamarine","mediumaquamarine","cornflowerblue",
                  "cornflowerblue","cornflowerblue","mediumaquamarine",
                  "mediumaquamarine","cornflowerblue","palevioletred",
                  "palevioletred","orange","orange","palevioletred","orange"])
